...
class AlternativesControllerTest < ActionController::TestCase
  ...
  test "should create alternative" do
    assert_difference('Alternative.count') do
      post :create, alternative: { desc: @alternative.desc, name: @alternative.name, problem_id: @alternative.problem_id, tw_hash: @alternative.tw_hash }
    end
  ...
  test "should update alternative" do
    patch :update, id: @alternative, alternative: { desc: @alternative.desc, name: @alternative.name, problem_id: @alternative.problem_id, tw_hash: @alternative.tw_hash }
    assert_redirected_to alternative_path(assigns(:alternative))
  end
